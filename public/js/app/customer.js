(function() {
    ...
    var customerCities = document.getElementById(`${model}-city`);
    var customerCountries = document.getElementById(`${model}-country`);
    M.Autocomplete.init(customerCities, {
        data: {
            "Beni": null, "Chuquisaca": null, "Cochabamba": null, "La Paz": null, "Oruro": null, "Pando": null, "Potosí": null, "Santa Cruz": null, "Tarija": null
        },
        limit: 5
    });
    M.Autocomplete.init(customerCountries, {
        data: {
